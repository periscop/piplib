...
\item {\tt Max}: a boolean set to 0 if the lexicographic
      minimum is asked, or to 1 for the lexicographic maximum. When trying to
      find the lexicographic maximum, the used method is the one
      ...
      constraint system (don't forget this when processing the output).
\end{enumerate}
...
\item {\tt Max} $= 0$: compute the lexicographic minimum.
\end{itemize}
